...
const errorMessages: Record<string, string> = {
  ...
  'edit-not-allowed': 'Only open, not-yet-triggered PO alerts can be edited.',
  'cancel-not-allowed': 'Only open, not-yet-triggered PO alerts can be canceled.'
};
...
export default async function PurchaseOrderAlertsPage({
  ...
  const successMessages: Record<string, string> = {
    ...
    cancelled: 'Tracked PO canceled successfully.'
  };
  const successMessage = searchParams.success ? successMessages[searchParams.success] ?? 'PO alert saved successfully.' : null;
